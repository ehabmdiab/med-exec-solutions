  ...
  return (
    <section className="py-20 lg:py-28 bg-background">
      <div className="container-wide grid md:grid-cols-2 gap-6 lg:gap-8">
        <Reveal>
          <div className="h-full rounded-2xl bg-secondary text-secondary-foreground p-8 lg:p-10 shadow-elevate relative overflow-hidden noise-overlay">
            ...
            <p className="mt-5 text-xs font-semibold uppercase tracking-[0.2em] text-secondary-foreground/60 relative z-10">{t.mv.mission.label}</p>
        ...
        <Reveal delay={120}>
          <div className="h-full rounded-2xl bg-card border border-border p-8 lg:p-10 hover-lift gradient-border-hover relative overflow-hidden">
            ...
            <p className="mt-3 font-display text-2xl lg:text-3xl font-bold leading-tight text-secondary">{t.mv.vision.text}</p>
          </div>
        </Reveal>
      </div>
    </section>
