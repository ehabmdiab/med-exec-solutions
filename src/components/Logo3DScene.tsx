...
function StudioLighting() {
  return (
    <>
      ...
      <directionalLight position={[2.8, 4.6, 5.2]} intensity={1.35} castShadow shadow-mapSize-width={1536} shadow-mapSize-height={1536} />
